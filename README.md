# Route66 GitHub Paket v72 · Online/Offline App
...
Die Cache-Version wurde auf `route66-trip-v72-complete-offline-status` gesetzt. Falls auf dem Smartphone noch alte Inhalte erscheinen: App schließen, Seite neu laden oder Browser-/PWA-Cache löschen.
