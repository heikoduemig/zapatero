...
Die Cache-Version wurde auf `route66-trip-v70-online-offline-app` gesetzt. Falls auf dem Smartphone noch alte Inhalte erscheinen: App schließen, Seite neu laden oder Browser-/PWA-Cache löschen.
